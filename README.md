...
## 2.3 Compile-time discovery (no runtime scanning)
...
## 2.4 Context per dispatch (explicit scoping)
...
## 2.5 Middleware and pipeline model
...
## 2.6 Explicit pipeline precedence (implemented in the dispatcher)
...
## 2.7 How pipelines are generated
...
## 2.8 Generated pipeline examples
...
## 2.9 How pipeline DI registrations are applied
...
## 2.11 When not to use TinyDispatcher
